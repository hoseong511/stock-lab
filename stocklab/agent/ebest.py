...
class EBest:
    ...
    def _execute_query(self, res, in_block_name, out_block_name, *out_fields, **set_fields):
        ...
        :param out_fields: list 출력 필드 리스트
        :param set_fields: dict 인 블록에 설정할 필드 딕셔너리
    ...
    def get_account_info(self):
        ...
        :return: list Field CSPAQ12200 참고
        """
    ...
    def order_check(self, order_no):
        ...
        out_params = ["ordno", "expcode", "medosu", "qty", "price", "cheqty", "cheprice", "ordrem",
                      "cfmqty", "status", "orgordno", "ordgb", "ordermtd", "sysprocseq", "hogagb",
                      "price1", "orggb", "singb", "loandt"]
